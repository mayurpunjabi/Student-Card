...
<h1>Vivekanand Education Society's College of Arts, Science and Commerce</h1>
<h2>Student Card</h2>
</div>
</div>

<nav class="navbar navbar-dark bg-dark" style="padding:0;margin:0;display:inline-block;width:100%;">
	<span class="left"><a class="active" href="#profile">PROFILE</a></span>
	<span class="left"><a href="../FirstYear">FIRST YEAR</a></span>
	<span class="left"><a href="../SecondYear">SECOND YEAR</a></span>
	<span class="left"><a href="../ThirdYear">THIRD YEAR</a></span>	
	<ul class="nav right" style="float:right;margin:0.5% 0%;">
		<li class="dropdown">
